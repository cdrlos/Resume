...
\begin{resume}%
  ...
  \emph{Domain-specific languages}: Latex, SQL, Asymptote\\
  ...
  \emph{Text editing software}: Emacs, Vim\\
  \emph{Typesetting software}: LibreOffice Writer, Google Docs\\
  \emph{Spreadsheets software}: LibreOffice Calc, Google Sheets\\
  \emph{Software versioning}: Git\\
