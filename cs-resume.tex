...
\begin{document}
\name{\vspace{-3pt}\LARGE Carlos Salinas\\[5pt]} % the \\[12pt] adds a blank line after name
\address{\small
...
\begin{resume}%
  ...
  \textsl{Languages}: English (native), Spanish (native), Russian (fluent), Persian (conversant)
  %%%% NEW SECTION
  \vspace{-7pt}
