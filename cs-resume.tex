...
\address{\small7507 Camelot Dr. \\ \small Mission, TX 78572\\
  \small\faPhone~\href{tel:17653379606}{\textnormal{765-337-9606}}}%
\address{
  \small\faEnvelope~\texttt{\href{mailto:cemiliosal@gmail.com}{cemiliosal@gmail.com}, \href{mailto:salinac@purdue.edu}{salinac@purdue.edu}}\\
...
\begin{resume}%
  ...
  \emph{Operating systems}: Linux (Debian, Fedora, Gentoo), FreeBSD, Windows\\
  ...
  \begin{itemize} \itemsep -3pt
    ...
    \item Graded differential equations and linear algebra courses at the
      ...
      \item Created and updated a \href{https://www.math.purdue.edu/~salinac}{university website} to post notes and solutions to
  ...
  Edinburg, TX
  \begin{itemize} \itemsep -3pt %reduce space between items
    \item Administrated the department's Experimental Algebra and Geometry Lab's Fedora cluster.
    \item Maintained an operational CUDALink computing station for doing Mathematica simulations.
    \item Operated and updated the lab's $3$D printer.
