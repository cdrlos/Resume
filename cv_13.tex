...
\title{Carlos Salinas -- Resume} % Print the main header

%------------------------------------------------

\parbox{0.5\textwidth}{ % First block
\begin{tabbing} % Enables tabbing
\hspace{0.75in} \= \hspace{1.25in} \= \kill % Spacing within the block
\small {\bf Address:} \> \small 7507 Camelot Dr\\ % Address line 1
\> \small Mission, TX 78572 \\ % Address line 2
\end{tabbing}}
\hfill % Horizontal space between the two blocks
\parbox{0.5\textwidth}{ % Second block
\begin{tabbing} % Enables tabbing
\hspace{0.75in} \= \hspace{1.25in} \= \kill % Spacing within the block
\small {\bf Phone:} \>\small \href{tel:+17653379606}{(765) 337-9606} \\ % Mobile phone
\small {\bf Email:} \>\small \href{mailto:cemiliosal@gmail.com}{cemiliosal@gmail.com} \\ % Email address
\small {\bf Github:} \>\small \href{https://github.com/cdrlos}{cdrlos}
\end{tabbing}}
